...
namespace SpPerfChart
{
    ...
    public partial class PerfChart : UserControl
    {
        ...
        protected int visibleValues = 0;
        // Horizontal value space in Pixels
        protected int valueSpacing = 5;
        ...
        protected int gridScrollOffset = 0;
        // The current average value
        protected decimal averageValue = 0;
        // Border Style
        protected Border3DStyle b3dstyle = Border3DStyle.Sunken;
        // Scale mode for value aspect ratio
        protected ScaleMode scaleMode = ScaleMode.Absolute;
        // Timer Mode
        protected TimerMode timerMode;
        // List of stored values
        protected List<decimal> drawValues = new List<decimal>(MAX_VALUE_COUNT);
        // Value queue for Timer Modes
        protected Queue<decimal> waitingValues = new Queue<decimal>();
        // Style and Design
        protected PerfChartStyle perfChartStyle;
        ...
        /// </summary>
        /// <returns></returns>
        internal decimal GetHighestValueForRelativeMode()
        {
            decimal maxValue = 0;
        ...
        public void DrawChart(Graphics g) {
            ...
            for (int i = 0; i < visibleValues; i++) {
                ...
                currentPoint.Y = Math.Min(CalcVerticalPosition(drawValues[i]), this.Height - 1);
            ...
            if (perfChartStyle.ShowCurrentMaxValue && scaleMode == ScaleMode.Relative) {
        ...
        internal void DrawAverageLine(Graphics g)
        {
            for (int i = 0; i < visibleValues; i++)
        ...
        public void DrawBackgroundAndGrid(Graphics g) {
